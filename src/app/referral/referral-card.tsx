...
export function ReferralCodeCard({ code, name }: { code: string; name?: string | null }) {
  ...
  return (
    <div className="bg-gradient-to-br from-brand-red-600 to-brand-red-700 rounded-2xl p-5 shadow-[0_8px_28px_rgba(225,29,42,0.38)] relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="flex gap-2 mb-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-white text-brand-red-700 text-sm font-bold py-2.5 rounded-xl hover:bg-white/90 active:scale-[0.97] transition-all"
          >
