      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex gap-2 pt-1">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-1.5 py-2 text-sm font-medium bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 disabled:opacity-50 transition-colors"
          >
