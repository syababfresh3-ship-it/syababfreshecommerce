...
async function getAffiliateData() {
  ...
  const [profileRes, commissionsRes, withdrawalsRes, appSettings, referralsRes] = await Promise.all([
  ...
  const commissionRate = parseFloat(appSettings.affiliate_commission_pct ?? '0.01')
